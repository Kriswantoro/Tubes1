...
//tampil user
	...
	<table class='table'>
		<tr>
			<th scope='col'>No</th><th scope='col'>Foto</th><th scope='col'>Judul</th><th scope='col'>Genre</th><th scope='col'>Tahun</th><th scope='col'>Aksi</th>
		</tr>";
		...
		while ($r=mysqli_fetch_array($tampil)) {
			...
			<td><a class='btn btn-primary' href=?module=anime&act=editanime&id=$r[id_anime]>Edit</a>
				<a class='btn btn-danger' href=\"aksi.php?module=mobil&act=hapus&id=$r[id_anime]\" onClick=\"return confirm('apakah anda benar akan menghapus data mobil $r[id_anime]?')\">Hapus</a>
			</td></tr>";
			$no++;
		}
...
//edit user
					...
					<div>
					<input class='form-control' name='id_anime' type='hidden' id='judul' placeholder='Judul' >
			  				<div class='form-group'>
			    				<input class='form-control' name='judul' type='text' id='judul' placeholder='Judul Anime'>
			  				</div>
			  				<div class='form-group'>
			    				<textarea class='mytextarea' name='genre' type='text' id='mytextarea'></textarea>
			  				</div>
			  				<div class='form-group'>
			    				<input  name='tahun' type='no' id='tahun' placeholder='Tahun'>
			  				</div>
